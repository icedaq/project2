...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_axis_array_v1_0 is
  ...
  signal m00_reg_tvalid_i_1_n_0 : STD_LOGIC;
begin
  m00_axis_tvalid <= \^m00_axis_tvalid\;
m00_reg_tvalid_i_1: unisim.vcomponents.LUT2
    generic map(
      INIT => X"E"
    )
        port map (
      I0 => \^m00_axis_tvalid\,
      I1 => s00_axis_tvalid,
      O => m00_reg_tvalid_i_1_n_0
    );
m00_reg_tvalid_reg: unisim.vcomponents.FDRE
    generic map(
      INIT => '0'
    )
        port map (
