...
proc create_root_design { parentCell } {
  ...
  # Create instance: axis_array_ip_0, and set properties
  set axis_array_ip_0 [ create_bd_cell -type ip -vlnv user.org:user:axis_array_ip:1.0 axis_array_ip_0 ]

  set_property -dict [ list \
   CONFIG.TDATA_NUM_BYTES {4} \
   CONFIG.HAS_TSTRB {1} \
 ] [get_bd_intf_pins /axis_array_ip_0/m00_axis]
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins axis_array_ip_0/s00_axis]
  ...
  connect_bd_intf_net -intf_net axis_array_ip_0_m00_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_array_ip_0/m00_axis]
