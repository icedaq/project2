...
#include <stdlib.h>
#include <string.h>
#include "output_data/headerfile_quantized.h"
...
void readImageTestData (unsigned char testData[10000][784][1])
{
    ...
    ptr = fopen("input_data/t10k-images-idx3-ubyte","rb");  // r for read, b for binary
...
void readImageTestLabels (unsigned char testLabels[10000])
{
    ...
    ptr = fopen("input_data/t10k-labels-idx1-ubyte","rb");  // r for read, b for binary
        ...
        for( int i = 0 ; i < wRows ; i++ ){
            for( int j = 0 ; j < xCols ; j++ ){
                ...
                for( int k = 0 ; k < wCols ; k++ ) {
                    ...
                    // We can remove Z_w since it is a constant and it is just for scaling.
                    // THIS WORKS: C[i][j] += (int)(( wInt - Z_w ) * dataInt);
                }
            }
        }
